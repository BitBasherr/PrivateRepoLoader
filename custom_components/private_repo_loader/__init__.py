"""Private Repo Loader – keeps private repos in sync & reloads HACS."""
...
from .const import DOMAIN, CONF_TOKEN, DATA_REPOS
from .loader import sync_repo, CONF_REPO, CONF_SLUG, CONF_BRANCH
...
async def _sync_all(hass: HomeAssistant, repos: list[dict]) -> None:
    ...
    await asyncio.gather(
        *[loop(sync_repo, root, r) for r in repos]
    )
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # First run: after HA fully started
